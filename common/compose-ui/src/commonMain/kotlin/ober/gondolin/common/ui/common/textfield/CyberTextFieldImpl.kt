...
internal fun CyberTextFieldImpl(
    enabled: Boolean,
    readOnly: Boolean,
    ...
    CyberTextFieldTransitionScope.Transition(
...
private object CyberTextFieldTransitionScope {
    @Composable
    fun Transition(
